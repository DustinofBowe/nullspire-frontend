...
export default function AdminPage() {
  ...
  // Edit state and handler
  const [editId, setEditId] = useState(null);
  const [editData, setEditData] = useState({ name: "", level: "", organization: "", profession: "" });
  ...
  const saveEdit = () => {
    ...
    fetch(`${API_BASE}/approved/${editId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "x-admin-password": ADMIN_PASSWORD,
